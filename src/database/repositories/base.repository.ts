...
import { ApiResponse, PaginationMeta } from '../../common/responses/api.response';
 ...
 *
 * Used by: AuthRepository, UserRepository, and any future feature repository.
 * See also: PrismaService → src/database/prisma/prisma.service.ts
 */
