 ...
 * Provided globally via CoreCacheModule (@Global).
 *
 * Methods:
 ...
 *          in-memory store in development/test (configured in CoreCacheModule).
 *
 * Used by: UserService
 * See also: CACHE_KEYS → src/shared/constants/app.constants.ts
 */
@Injectable()
