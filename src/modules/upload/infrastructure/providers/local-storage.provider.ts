...
import { LocalSignedUrlService } from '../signing/local-signed-url.service';
 ...
 *  1. Server-mediated  : POST /v1/upload/:type       (Multer + processing pipeline)
 *  2. HMAC-presigned   : POST /v1/upload/presigned-url → PUT /upload/local/direct
 *
