 ...
 *
 * Layer: domain/interfaces — the abstract port the application layer depends
 * on. Concrete adapters live in `infrastructure/providers/`.
 *
 * Goal
 ...
 *     1. Implement IStorageProvider in a new class under infrastructure/providers/.
 *     2. Register it in the PROVIDER_CLASS_REGISTRY map in upload.module.ts.
