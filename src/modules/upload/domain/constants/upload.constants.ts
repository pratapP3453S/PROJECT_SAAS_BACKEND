 ...
 *
 * Lives in `domain/constants/` because these tokens are the contract the
 * application + api layers depend on. Concrete providers (infrastructure) are
 * bound to these tokens by `upload.module.ts` at composition time.
 *
