...
/**
 * RefreshTokenDto — request body for POST /v1/auth/refresh.
...
/**
 * ChangePasswordDto — request body for a future PUT /v1/auth/change-password endpoint.
...
/**
 * ForgotPasswordDto — request body for a future POST /v1/auth/forgot-password endpoint.
...
/**
 * ResetPasswordDto — request body for a future POST /v1/auth/reset-password endpoint.
